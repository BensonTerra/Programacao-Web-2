...
exports.findAll = async (req, res, next) => {
    ...
    try {
        ...
        /*
        orders.rows.forEach(ing => {
            let order = await 
        });
        */

        /*
        orders.rows.forEach(tut => {
            tut.links = [
...
exports.findOne = async (req, res, next) => {
    try {
        ...
        let tutorial = await Order.findByPk(req.params.idT, {
            include: [
                { // EAGER LOADING
                    model: db.comment,
...
exports.update = async (req, res, next) => {
    try {
        ...
        // obtains only a single entry from the table, using the provided primary key
        let affectedRows = await Order.update(req.body, { where: { id: req.params.idT } })
...
exports.delete = async (req, res, next) => {
    try {
        let result = await Order.destroy({ where: { id: req.params.idT } })
