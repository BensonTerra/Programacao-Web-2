function createError(statusCode, message) {
  ...
  module.exports = {
    DATABASE_ERROR: createError(500, 'Erro ao aceder a base de dados'),
    RESOURCE_NOT_FOUND: createError(404, 'O recurso pedido não existe'),
    ...
    NO_BODY_DATA: createError(400, 'Pedido sem dados: dados obrigatarios - name e city'),
